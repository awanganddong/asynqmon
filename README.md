...
# Web UI for monitoring & administering [Asynq](https://github.com/awanganddong/asynq) task queue

## Overview

Asynqmon is a web UI tool for monitoring and administering [Asynq](https://github.com/awanganddong/asynq) queues and tasks.
...
You can download the release binary for your system from the [releases page](https://github.com/awanganddong/asynqmon/releases).
...
| `---redis-url`(string)            | `REDIS_URL`               | URL to redis or sentinel server. See [godoc](https://pkg.go.dev/github.com/awanganddong/asynq#ParseRedisURI) for supported format | ""               |
...
[![GoDoc](https://godoc.org/github.com/awanganddong/asynqmon?status.svg)](https://godoc.org/github.com/awanganddong/asynqmon)
...
import (
	...
	"github.com/awanganddong/asynqmon"
)
...
Copyright (c) 2019-present [Ken Hibino](https://github.com/hibiken) and [Contributors](https://github.com/awanganddong/asynqmon/graphs/contributors). `Asynqmon` is free and open-source software licensed under the [MIT License](https://github.com/awanganddong/asynq/blob/master/LICENSE). Official logo was created by [Vic Shóstak](https://github.com/koddr) and distributed under [Creative Commons](https://creativecommons.org/publicdomain/zero/1.0/) license (CC0 1.0 Universal).
